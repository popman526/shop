...
<<<<<<< HEAD
					...
					<div class="wrap">
						<div class="main">
							...
							<div class="main_img" title="메인이미지">
                                ...
                                <img src="/product/mainImageDown?product_id=${each.product_id}" id="main_img"></a>
							</div>
							<div class="auth-info">
								<i class="icon-add-comment"></i>
								<span class="time"><fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${each.reg_dt}" /></span>
								<a href="#" class="author">${each.reg_id}</a>
							</div>
						</div>
					</div>
				</li>
			...
			<div class="row">
				...
				<div class="col-md-3 qna-write">
					<a href="/product/form" class="btn btn-primary pull-right" role="button">상품등록</a>
				</div>
			</div>
		</div>
	</div>
  ...
  <div class="modal-content">
      ...
      <div class="modal-body">
          <form class="form col-md-12 center-block">
              <div class="form-group">
                  <label for="customer_id">사용자 아이디</label>
                  <input class="form-control" name="customer_id" placeholder="User ID">
              </div>
              <div class="form-group">
                  <label for="customer_pw">비밀번호</label>
                  <input type="password" class="form-control" name="customer_pw" placeholder="Password">
