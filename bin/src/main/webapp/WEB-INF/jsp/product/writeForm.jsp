...
<div class="container" id="main">
   <div class="col-md-12 col-sm-12 col-lg-10 col-lg-offset-1">
      <div class="panel panel-default content-main">
          <form name="product" method="post" action="/product/create" enctype="multipart/form-data">
              ...
              <button type="submit" class="btn btn-success clearfix pull-right">상품등록</button>
              <div class="clearfix" />
          </form>
        </div>
    </div>
